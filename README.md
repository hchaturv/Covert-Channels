...
Assumptions:
	...
	2. 	Profiling is being done by using ping response time. I will later pass on a paper that proves that ping responses can be used to compute with high accuracy the cpu load.
